...
class MesaPerf:
    def __init__(self):
        ...
        self._flags = {
            "skl": ['-march=skylake', '-mmmx', '-mno-3dnow', '-msse', '-msse2',
                    'msse3', '-mssse3', '-mno-sse4a', '-mcx16', '-msahf', '-mmovbe',
                    'maes', '-mno-sha', '-mpclmul', '-mpopcnt', '-mabm', '-mno-lwp',
                    'mfma', '-mno-fma4', '-mno-xop', '-mbmi', '-mbmi2', '-mno-tbm',
                    'mavx', '-mavx2', '-msse4.2', '-msse4.1', '-mlzcnt', '-mno-rtm',
                    'mno-hle', '-mrdrnd', '-mf16c', '-mfsgsbase', '-mrdseed',
                    ...
                    '-param l2-cache-size=4096', '-mtune=skylake'],
            "bdw": ['-march=broadwell', '-mmmx', '-mno-3dnow', '-msse',
                    ...
                    '--param l2-cache-size=6144', '-mtune=broadwell'],
            "bsw": ['-march=silvermont', '-mmmx-mno-3dnow', '-msse', '-msse2',
                    '-msse3', '-mssse3', '-mno-sse4a', '-mcx16', '-msahf',
                    '-mmovbe', '-maes', '-mno-sha', '-mpclmul',
                    '-mpopcnt-mno-abm', '-mno-lwp', '-mno-fma', '-mno-fma4',
                    '-mno-xop', '-mno-bmi', '-mno-bmi2', '-mno-tbm',
                    '-mno-avx', '-mno-avx2', '-msse4.2', '-msse4.1',
                    '-mno-lzcnt', '-mno-rtm', '-mno-hle', '-mrdrnd',
                    '-mno-f16c', '-mno-fsgsbase', '-mno-rdseed', '-mprfchw',
                    '-mno-adx', '-mfxsr', '-mno-xsave', '-mno-xsaveopt',
                    '-mno-avx512f', '-mno-avx512er', '-mno-avx512cd',
                    '-mno-avx512pf', '-mno-prefetchwt1', '-mno-clflushopt',
                    '-mno-xsavec', '-mno-xsaves', '-mno-avx512dq',
                    '-mno-avx512bw', '-mno-avx512vl', '-mno-avx512ifma',
                    '-mno-avx512vbmi-mno-clwb', '-mno-mwaitx', '-mno-clzero',
                    '-mno-pku', '--param l1-cache-size=24',
                    '--param l1-cache-line-size=64',
